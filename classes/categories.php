...
class categories
{
    ...
    public function insert($name)
    {
        ...
        if ($result) {
            $alert = "<span class='success'>Add successful category</span>";
            return $alert;
        } else {
            $alert = "<span class='error'>Add failure category</span>";
            return $alert;
        }
    }
    ...
    public function update($data)
    {
        ...
        if ($result) {
            $alert = "<span class='success'>Catalog update successful</span>";
            return $alert;
        } else {
            $alert = "<span class='error'>Catalog update failed</span>";
            return $alert;
        }
    }
