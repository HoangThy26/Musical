	...
	public function insert($data)
	{
		...
		if ($result_check) {
			...
			if ($result) {
				...
				$mail->Subject = "Confirm account email - Instruments Store";
				$mail->Body = "<h3>Thank you for registering an account at the InstrumentStore website</h3></br>This is your account verification code: " . $captcha . "";
