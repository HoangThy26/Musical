    ...
    <nav>
        ...
        <ul>
            ...
            if (isset($_SESSION['user']) && $_SESSION['user']) { ?>
                <li><a href="logout.php" id="signin">Signin</a></li>
            <?php } else { ?>
                <li><a href="register.php" id="signup">Signup</a></li>
                <li><a href="login.php" id="signin">Signin</a></li>
            <?php } ?>
        ...
        if ($list) { ?>
            <table class="order">
                ...
                foreach ($list as $key => $value) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="delete_cart.php?id=<?= $value['id'] ?>">Delete</a>
                        </td>
                    </tr>
                <?php }
                ?>
            ...
            <div class="orderinfo">
                ...
                <h3>Order Information</h3>
                     ...
                     <div>
                         Total amount: <b id="totalcart"><?= number_format($totalPrice['total'], 0, '', ',') ?>VND</b>
                     </div>
                     <div>
